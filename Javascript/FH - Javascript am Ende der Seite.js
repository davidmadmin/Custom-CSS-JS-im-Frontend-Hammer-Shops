    ...
    style.textContent = `
      ...
      #free-shipping-bar .fh-free-shipping__progress {
        ...
        background: linear-gradient(
          90deg,
          color-mix(in srgb, var(--fh-free-shipping-primary) 70%, transparent) 0%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 78%, transparent) 22%,
          rgba(255, 255, 255, 0.22) 40%,
          rgba(255, 255, 255, 0.22) 64%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 84%, transparent) 84%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 74%, transparent) 100%
        );
