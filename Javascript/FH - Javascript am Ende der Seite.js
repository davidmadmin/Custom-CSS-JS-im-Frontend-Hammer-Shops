    ...
    style.textContent = `
      ...
      #free-shipping-bar .fh-free-shipping__progress {
        ...
        background: linear-gradient(
          90deg,
          color-mix(in srgb, var(--fh-free-shipping-primary) 72%, transparent) 0%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 84%, transparent) 28%,
          rgba(255, 255, 255, 0.38) 50%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 90%, white 12%) 72%,
          color-mix(in srgb, var(--fh-free-shipping-primary) 68%, transparent) 100%
        );
        background-size: 320% 100%;
        animation: fh-free-shipping-progress-shine 9.6s ease-in-out infinite;
