...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initializeAccountMenu(container) {
    if (!container || container.getAttribute('data-fh-account-menu-initialized') === 'true') {
      return;
    }

    container.setAttribute('data-fh-account-menu-initialized', 'true');
  ...
  const initialContainer = document.querySelector('[data-fh-account-menu-container]');

  if (initialContainer) {
    initializeAccountMenu(initialContainer);
  }

  const accountMenuObserver = new MutationObserver(function () {
    const nextContainer = document.querySelector('[data-fh-account-menu-container]:not([data-fh-account-menu-initialized="true"])');

    if (nextContainer) {
      initializeAccountMenu(nextContainer);
    }
  });
...
document.addEventListener('DOMContentLoaded', function () {
  function setupWishListMenu(attempt) {
      ...
      if (container.getAttribute('data-fh-wishlist-menu-initialized') === 'true') {
        return;
      }

      container.setAttribute('data-fh-wishlist-menu-initialized', 'true');
