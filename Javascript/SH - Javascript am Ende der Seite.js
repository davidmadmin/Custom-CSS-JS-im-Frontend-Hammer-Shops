...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var navs = document.querySelectorAll(".single .nav.nav-tabs");
    ...
    Array.prototype.forEach.call(navs, function (nav) {
      ...
      if (nav.dataset.shTabsTransformed === "true") return;

      var tabContent = findTabContent(nav);

      if (!(tabContent instanceof HTMLElement) || tabContent.classList.contains("sh-tab-toggle-ready")) return;
      ...
      tabContent.classList.add("sh-tab-toggle-ready");
      tabContent.setAttribute("data-sh-tabs-transformed", "true");

      panes.forEach(function (pane, index) {
        if (!(pane instanceof HTMLElement)) return;

        var existingId = normaliseLabel(pane.id || "");
        var paneId = existingId || "sh-product-tab-pane-" + index;
        ...
        pane.classList.add("sh-tab-toggle-pane");

        var button = document.createElement("button");
        button.type = "button";
        button.className = "sh-tab-toggle-button";
        ...
        content.className = "sh-tab-toggle-content";
      ...
      nav.dataset.shTabsTransformed = "true";
