...
shOnReady(function () {
  const STORAGE_KEY = 'sh:basket-preview-state';
  const COUNT_SELECTOR = '.sh-header__basket-count';
  const TOTAL_SELECTOR = '.sh-header__basket-total';
  const SR_TOTAL_SELECTOR = '.sh-header__sr-only';
