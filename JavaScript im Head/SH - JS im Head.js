...
shOnReady(function () {
  ...
  const emptyState = container.querySelector('[data-sh-wishlist-empty]');
  const badgeCount = toggleButton ? toggleButton.querySelector('.sh-header__badge span') : null;
  ...
  function renderWishListItems(items) {
    ...
    items.forEach(function (entry) {
      ...
      itemElement.className = 'sh-header__wishlist-item';
      ...
      if (imageUrl) {
        ...
        image.src = imageUrl;
        image.alt = name;
        image.className = 'sh-header__wishlist-image';
        itemElement.appendChild(image);
      }

      const label = document.createElement(url ? 'a' : 'span');
      if (url) label.href = url;
      label.className = 'sh-header__wishlist-title';
